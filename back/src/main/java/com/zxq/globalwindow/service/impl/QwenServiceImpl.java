...
public class QwenServiceImpl implements QwenService {
    ...
    public String callQwen(String userInput) {
        ...
        String jsonInputString = String.format("{\"model\": \"qwen1.5-0.5b-chat\", \"input\": {\"messages\": [{\"role\": \"system\", \"content\": \"你的任务是对新闻或者事件生成一个文本摘要。最多30个词汇。\"}, {\"role\": \"user\", \"content\": \"%s\"}]}, \"parameters\": {\"result_format\": \"message\"}}", userInput);
