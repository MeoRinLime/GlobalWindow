...
public class eventController {
    ...
    public List<hotspots> hotspots(@RequestParam Integer limitNum){
        ...
        List<event> events = eventService.findRBypopularity(limitNum,now.minus(2, ChronoUnit.DAYS));
    ...
    public List<eventPlusLink> getHotEventBySource(String source,Integer limitNum){
        ...
        List<event> eventList = eventService.findHotBysource(source,limitNum,now.minus(2,ChronoUnit.DAYS));
